...
exports.findById = async (req, res, next) => {
    try {
        ...
        return next(new ApiError(500, `Error retrieving Publish with id=${req.params.id}`));
    }
};
...
exports.delete = async (req, res, next) => {
    try {
        ...
        return next(new ApiError(500, `Could not delete Publish with id=${req.params.id}`));
    }
};